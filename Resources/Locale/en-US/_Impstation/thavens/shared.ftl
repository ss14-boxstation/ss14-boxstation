...
thaven-mood-station-is-alive-desc = Harming or modifying the station is abhorrent. You should shun and attempt to non-violently disrupt further modification.
...
thaven-mood-one-true-thaven-desc = You are the only real thaven on the station, the others are just harmless pretenders.
...
thaven-mood-must-congregate-desc = You should make time to congregate with your fellow Thaven. To be without them for long is harrowing.
