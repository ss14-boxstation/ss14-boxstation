...
hitman-sharpshooter-kit-description =
    ...
    Provides a Hristov with ammo along with an outfit.
    all items are in a briefcase.

hitman-loud-kit-name = Loud kit
hitman-loud-kit-description =
    A kit for those who like a direct method.
    Provides a Python with Armor-Piercing rounds.
    Two speedloaders with Armor-Piercing rounds.
    along with a armor vest and no-slip shoes.
...
hitman-tracker-kit-description =
    ...
    Provides a station master encryption key, universal pinpointer,
    And a camera bug.

# Box Change - Hitman > Contract Killer
hitman-briefcase-window-title = contract killer briefcase
