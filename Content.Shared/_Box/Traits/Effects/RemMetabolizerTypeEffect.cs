...
/// <summary>
/// Effect that removes metabolizer types from the player entity's organs.
/// </summary>
public sealed partial class RemMetabolizerTypeEffect : BaseTraitEffect
{
    /// <summary>
    /// The metabolizer types to remove from the entity.
    /// </summary>
        ...
        foreach (var organ in body.Organs.ContainedEntities)
        {
            ...
            foreach (var type in Types)
            {
                if (!comp.MetabolizerTypes.Contains(type))
                    continue;
                comp.MetabolizerTypes.Remove(type);
            }
        }
    }
}
