...
public abstract partial class SharedPuddleSystem : EntitySystem
{
    ...
    private void OnSolutionUpdate(Entity<PuddleComponent> entity, ref SolutionContainerChangedEvent args)
    {
        ...
        UpdateSlow(entity, args.Solution, entity.Comp); // // Box Change: starcup/CorvaxNext footprints
    ...
    private void UpdateSlow(EntityUid uid, Solution solution, PuddleComponent component) // // Box Change: CorvaxNext: add component parameter
    {
        // Box Change: starcup/CorvaxNext footprints
