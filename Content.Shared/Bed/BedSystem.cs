...
public sealed class BedSystem : EntitySystem
{
    ...
    public override void Update(float frameTime)
    {
        ...
        while (query.MoveNext(out var uid, out _, out var bedComponent, out var strapComponent))
        {
            ...
            {
                if (_mobStateSystem.IsDead(healedEntity) || HasComp<SiliconComponent>(healedEntity)) // Box Change - Goobstation - IPCs, Add Silicon Component Check, IPCs shouldn't be healed by sleeping
                    continue;
