...
using Content.Shared.Emag.Systems; // Box - Emaggable Anom Generator port
...
public sealed partial class AnomalySystem
{
    ...
    private void InitializeGenerator()
    {
        ...
        SubscribeLocalEvent<AnomalyGeneratorComponent, GotEmaggedEvent>(OnEmagged); // Box - Emaggable Anom Generator port
    }
