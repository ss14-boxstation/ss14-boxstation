...
public sealed class StunGridOnTriggerSystem : EntitySystem
{
    ...
    {
        SubscribeLocalEvent<StunGridOnTriggerComponent, TriggerEvent>(OnActivated);
        _buckleQuery = GetEntityQuery<BuckleComponent>();
        _statusQuery = GetEntityQuery<StatusEffectsComponent>();

    }

    private void OnActivated(Entity<StunGridOnTriggerComponent> ent, ref TriggerEvent args)
    {
